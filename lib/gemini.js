...
- Use bullet points with regular asterisks: * item or - item (NOT \* escaped asterisks)
- Never use escaped characters like \*, \n, \_, etc. in your responses
- For lists, format as: "* Item Name: Description" or "- Item Name: Description"
- Keep formatting clean and readable - no backslashes or escape characters
- Example correct format: "* **Item Name:** Description here"
- Example incorrect format: "\* Item Name: Description" (NO backslashes!)

**Important:** Keep your responses focused and valuable. Users appreciate efficiency and clarity over lengthy explanations. Always use proper markdown formatting without escape characters.`;
