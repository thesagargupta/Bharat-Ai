...
- **N8N** instance (optional, for webhook-based AI)

### Installation

1. **Clone the repository**
```bash
git clone https://github.com/thesagargupta/Bharat-Ai.git
cd Bharat-Ai
```
...
```env
# MongoDB
MONGODB_URI=mongodb+srv://username:password@cluster.mongodb.net/bharat-ai
...
# N8N Webhook (Optional - Alternative to Gemini)
N8N_WEBHOOK_URL=https://your-n8n-instance.com/webhook/bharat-ai
...
│   └── HistorySidebar.js  # Chat history sidebar
├── lib/
│   ├── gemini.js          # Gemini API integration
│   ├── n8n-webhook.js     # N8N webhook service
│   ├── mongodb.js         # Database connection
│   └── models.js          # MongoDB schemas
├── public/
│   ├── icons/             # App icons
│   └── googled4268790a4f3d218.html  # Google Search Console verification
...
4. Free tier: 250 requests/day per model
5. Paid tier: 10,000+ requests/minute

### N8N Webhook Setup (Alternative)

1. Set up [N8N](https://n8n.io/) instance
2. Create a workflow with webhook trigger
3. Add Gemini/OpenAI node for AI responses
4. Configure authentication
5. Add webhook URL to `.env.local`

**Benefits of N8N:**
- ✅ More control over AI logic
